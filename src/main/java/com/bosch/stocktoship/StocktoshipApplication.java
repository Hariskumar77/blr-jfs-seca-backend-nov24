...
/**
 * class for handling user interactions in the Quality Control process. This
 * application allows users to select different quality control stages, enter or
 * edit sample data, save it, and submit for inspection.
 * 
 * @author BPOO1KOR
 */
